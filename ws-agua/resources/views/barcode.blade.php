    ...
    <tbody>
        ...
        <tr>
            <td style="font-family:'Arial',Helvetica,sans-serif;font-size:12px;color:#5f6062;">
                ...
                A través de este email te notificamos el detalle de tu solicitud.<br><br>
                <strong> {{ $body }}</strong>
                <br><br><br>
                Su Código es <strong> {{ $code }}</strong>, el código adjunto puede ser utilizado por una única ocasión.
                <br><br><br>
                Atentamente,<br>
